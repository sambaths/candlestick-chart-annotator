...
class YfinanceDataProvider(DataProvider):
    ...
    def get_stock_data(self, symbol, start_date, end_date, resolution='1D'):
        """Get stock data from Yahoo Finance"""
        try:
            # Convert resolution to yfinance interval format
            interval_map = {
                '1D': '1d',
                '1H': '1h',
                '15': '15m',
    ...
    def get_nifty50_symbols(self):
        ...
        # you would fetch this from an API or database
        return [
...
def get_data_provider(provider_type: str, **kwargs) -> DataProvider:
    ...
    Args:
        provider_type: Type of data provider ('fyers', 'csv', or 'yfinance')
